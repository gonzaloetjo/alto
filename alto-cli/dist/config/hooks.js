 ...
 */
async function spawnPythonHook(hookPath, input, projectDir, signal) {
 ...
 */
function createHookCallback(hookName, hooksDir, projectDir) {
 ...
 */
export function buildHooks(projectDir, mode) {
 ...
 */
export function getPostToolUseMatchers(mode) {
    if (mode === "build") {
        return {
