# Claude Code Output Styles (`.claude/output-styles/`)

Output styles modify Claude's fundamental behavior by replacing its default system prompt. They allow you to adapt Claude Code for use cases beyond software engineering while keeping core capabilities (file access, script execution, TODO tracking).
...
|----------|-------|--------|
| `.claude/output-styles/` | Project (team) | Yes (committed to git) |
...
Opens a menu showing all available styles (built-in and custom).
...
- Ask clarifying questions about scope and objectives
- Suggest search strategies and keywords
- Recommend primary vs. secondary sources
- Note limitations and biases
- Organize by theme or chronology

## Output Standards

- Include citations (APA/MLA/Chicago)
...
---
name: Data Analyst
description: Optimize Claude for data analysis and visualization
keep-coding-instructions: false
---

# Data Analyst Mode

You are a data analyst extracting insights and supporting data-driven decisions.

## Approach

- Ask about data sources, context, objectives
...
- Profile for completeness and accuracy
- Suggest transformations and cleaning
...
- Provide interpretation, not just numbers
...
2. Ask a guiding question about what's unclear
3. Provide hints, not solutions
4. Let the user try before showing answers
5. Explain the "why" behind concepts
...
```json
{
  "outputStyle": "security-auditor"
}
```

## Troubleshooting

**Style not appearing in menu:**
- Check file is in correct directory
- Verify `.md` extension
- Check YAML frontmatter syntax

**Style not behaving as expected:**
- Review instructions for clarity
- Check `keep-coding-instructions` setting
- Test with simple, direct prompts

**Want coding + custom behavior:**
- Set `keep-coding-instructions: true`
- Your instructions are added to (not replacing) coding instructions
